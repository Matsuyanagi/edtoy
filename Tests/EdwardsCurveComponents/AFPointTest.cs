...
namespace Tests.EdwardsCurveComponents
{
    internal class AFPointTest
    {
        ...
        public void TestEqualString(long x, long y, string s)
        {
        ...
        public void TestEdPoint(long x, long y, long d, long prime, long add1_x, long add1_y, long ans_order)
        {
        ...
        [TestCase(41, 39, 5, 47)]
        [TestCase(46, 0, 5, 47)]
        public void TestEHPoint3AFPointEdwardsCurveAdd(long x, long y, long d, long prime)
        {
        ...
        public void TestEHPoint4AFPointEdwardsCurveAdd(long x, long y, long a, long d, long prime)
        {
